...
function checkUrlAndSetupPage(url) {
  if (url.lastIndexOf("#") != -1) {
    ...
    $("#styleguideTabs-content #styleguideTabs-" + str + "-content").addClass(
      "active"
    );
...
function setActiveSlide(slide, animation) {
  ...
  $(slide)
    ...
    .removeClass("active slideInLeftSmall slideInRightSmall fadeIn");
  $(slide).addClass("active");
  $(slide)
    .parent()
    .parent()
    .find("#" + slide.id + "-content")
...
function openModal(id) {
  ...
  $("#" + id)
    .before('<div id="' + id + '-placeholder"></div>')
    .detach()
    .appendTo("body")
    .removeClass("hide");
}
...
$(document).ready(function () {
  ...
  $("#styleguideSidebar .sidebar__item > a").click(function () {
    $("#styleguideSidebar .sidebar__item").removeClass(
  ...
  $(document).click(function () {
    ...
    $("#styleguideSidebar .sidebar__drawer").removeClass(
  ...
  $("main #masonry-columns-dropdown").change(function () {
    ...
    $("main #masonry-columns-example").addClass(
      "masonry masonry--cols-" + this.value
    );
  });
  $("main #masonry-gaps-dropdown").change(function () {
    $("main #masonry-gaps-example").removeClass();
    $("main #masonry-gaps-example").addClass(
      "masonry masonry--gap-" + this.value
    );
  });
